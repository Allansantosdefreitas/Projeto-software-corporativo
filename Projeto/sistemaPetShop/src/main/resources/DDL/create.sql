...
CREATE TABLE tb_consulta_geral (id_consulta_geral BIGINT NOT NULL, fk_funcionario BIGINT, fk_servico VARCHAR(255), PRIMARY KEY (id_consulta_geral))
...
ALTER TABLE tb_consulta_medica ADD CONSTRAINT FK_tb_consulta_medica_fk_consulta FOREIGN KEY (fk_consulta) REFERENCES tb_usuario (id_consulta_medica)
