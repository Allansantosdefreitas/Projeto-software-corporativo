...
=======
CREATE TABLE tb_servico (id_servico BIGINT AUTO_INCREMENT NOT NULL UNIQUE, str_nome VARCHAR(255) NOT NULL UNIQUE, dbl_valor DOUBLE NOT NULL UNIQUE, PRIMARY KEY (id_servico))
>>>>>>> d89a111e0a03b9369bdaa77e0e4b44ccd31bd6e4
